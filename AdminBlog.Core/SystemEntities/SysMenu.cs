    ...
    public class SysMenu : EntityExtend, IEntitySeedData<SysMenu>
    {
        ...
        public IEnumerable<SysMenu> HasData(DbContext dbContext, Type dbContextLocator)
        {
            return new List<SysMenu>
            {
                ...
                new SysMenu { Id = 188992024399941, MenuName = "编辑", MenuCode = "editBlog",MenuIcon="",MenuTitle="博客详情",ParentModuleID=183496627462213,MenuPath="editBlog/:id",SortIndex=-1,Component="editBlog",Hidden=true,AlwaysShow=false,CreatedTime=DateTimeOffset.UtcNow },
