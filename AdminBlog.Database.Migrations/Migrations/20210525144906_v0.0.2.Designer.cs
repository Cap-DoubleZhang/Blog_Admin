...
namespace AdminBlog.Database.Migrations.Migrations
{
    ...
    [Migration("20210525144906_v0.0.2")]
    partial class v002
    {
            ...
            modelBuilder.Entity("AdminBlog.Core.SysDictionary", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 160774000443461L,
                            Code = "BlogType",
                            CreatedTime = new DateTimeOffset(new DateTime(2021, 5, 25, 14, 49, 5, 822, DateTimeKind.Unspecified).AddTicks(3633), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "博客类型"
                        },
                        new
                        {
                            Id = 160776633155653L,
                            Code = "EmailType",
                            CreatedTime = new DateTimeOffset(new DateTime(2021, 5, 25, 14, 49, 5, 822, DateTimeKind.Unspecified).AddTicks(4124), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "邮箱类型"
                        });
                });
            ...
            modelBuilder.Entity("AdminBlog.Core.SysDictionaryDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 160774000443461L,
                            Code = "BlogType",
                            CreatedTime = new DateTimeOffset(new DateTime(2021, 5, 25, 14, 49, 5, 825, DateTimeKind.Unspecified).AddTicks(933), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = 160776633155653L,
                            Code = "BlogType",
                            CreatedTime = new DateTimeOffset(new DateTime(2021, 5, 25, 14, 49, 5, 825, DateTimeKind.Unspecified).AddTicks(967), new TimeSpan(0, 0, 0, 0, 0)),
                            DetailCode = "Article",
                            IsDeleted = false,
                            SortIndex = 1,
                            Value = "文章"
                        ...
                        new
                        {
                            Id = 161765323022405L,
                            Code = "EmailType",
                            CreatedTime = new DateTimeOffset(new DateTime(2021, 5, 25, 14, 49, 5, 825, DateTimeKind.Unspecified).AddTicks(970), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = 161765323022406L,
                            Code = "EmailType",
                            CreatedTime = new DateTimeOffset(new DateTime(2021, 5, 25, 14, 49, 5, 825, DateTimeKind.Unspecified).AddTicks(971), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("AdminBlog.Core.SysUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 156951674213412L,
                            CreatedTime = new DateTimeOffset(new DateTime(2021, 5, 25, 14, 49, 5, 840, DateTimeKind.Unspecified).AddTicks(7840), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            IsOnline = 0,
                            IsUse = 0,
                            LoginTimes = 0,
            ...
            modelBuilder.Entity("AdminBlog.Core.SysUserInfo", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 111111L,
                            CreatedTime = new DateTimeOffset(new DateTime(2021, 5, 25, 14, 49, 5, 842, DateTimeKind.Unspecified).AddTicks(8723), new TimeSpan(0, 0, 0, 0, 0)),
